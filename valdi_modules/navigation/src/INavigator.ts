 ...
 * @ExportEnum({ios: 'SCValdiINavigatorPageVisibility', iosImportPrefix: 'valdi_core', android: 'com.snap.valdi.navigation.INavigatorPageVisibility'})
 */
export enum INavigatorPageVisibility {
  HIDDEN = 0,
  VISIBLE = 1,
}
